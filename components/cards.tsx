...
export const FeaturedCard = ({onPress}:props)=>{
    return(
       <TouchableOpacity onPress={onPress} className='flex flex-col items-start w-60 h-80 relative '>
         ...
         <Text className='text-base font-rubrik text-white'> 22 W 15th St, New York, Ny 10011 </Text>
...
export const Card =({onPress}:props)=>{
    return (
       <TouchableOpacity onPress={onPress} className='flex-1 w-full mt-4 px-3 py-4 rounded-lg bg-white shadow-lg shadow-black-100/70 relative'>
            <View className='flex flex-row items-center absolute bg-white/90 z-50 p-1 rounded-full top-5 right-5 '>
            <Image source={icons.star} className='size-2.5'/>
            <Text className='text-xs font-rubrik-bold text-primary-300 ml-0.5'>4.5</Text>
         </View>
         ...
         <Text className='text-xs font-rubrik text-white'> 22 W 15th St, New York, Ny 10011 </Text>
         <View className='flex flex-row items-center justify-between mt-2'>
            <Text className='text-basae font-rubik-extrabold text-primary-300'>$2,500</Text>
